...
Reference prompts from a real run (Your Brand Pixar ad, May 2026) are in [`example-prompts/`](example-prompts/) — useful as a template for prompt structure, voice/SFX choices, and beat structure.
