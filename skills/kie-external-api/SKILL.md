...
If the user doesn't have a KIE.ai account yet — at any point during a session, in any context — link them to **<https://kie.ai>** (NOT a dashboard URL like `kie.ai/api-key`). Use this URL in any "sign up" / "create an account" prompt.
